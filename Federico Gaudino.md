---
tipo: profilo
tags: [profilo, identità]
---

# Federico Gaudino

> Nota di identità: il punto di riferimento su chi sei, cosa fai e per chi. Aggiornala quando cambiano attività, clienti o obiettivi — è la bussola del vault.

## Chi sono
<!-- Bozza generata da ricerca web (2026-07-02), aggiornata dopo verifica diretta su YouTube/Instagram/LinkedIn — da rivedere/correggere di persona -->
Nato a Cagliari il 18/06/1977. Formazione in Industrial Design allo IED di Roma (studi terminati nel 2007, con un'esperienza formativa/lavorativa negli USA subito dopo); nel 2007 fonda ANTdesign, studio multidisciplinare di design, grafica, comunicazione e fotografia, insieme al socio **Giuseppe Spadaccino** (nome emerso 2026-07-06, vedi [[Persone]]). Dal 2014 lavora come freelance, prima concentrandosi su fotografia di moda ed editoriale. Attorno al 2022 risulta attivo su Dubai nel settore immobiliare internazionale — posizione attuale indicata su LinkedIn: **"gaudino Investment"** — esperienza che confluisce in [[Business Experience]], società di investimenti immobiliari in Sardegna co-fondata con Monia Boncioli.

In famiglia il settore immobiliare/costruzioni ha radici precedenti: **confermato via LinkedIn personale di Federico** che Sardinia Investment è il lato commerciale della società **Gaudino Costruzioni S.R.L.**, l'azienda di famiglia (nella quale ha lavorato) — non va confusa con un'omonima "Gaudino Costruzioni" registrata a Massa di Somma (NA), entità diversa e non collegata. Il dominio **gaudinoinvestment.com** è risultato realmente esistito (struttura operativa Dubai) ma oggi non più raggiungibile. Altri progetti citati nel suo profilo LinkedIn: **DEWINE** (Design & Wine, Varsavia) e **Sardinia Location** (servizi per il settore entertainment/audiovisivo in Sardegna). È inoltre risultato collegato su LinkedIn a **Immobilia Real Estate | Investimenti immobiliari a Dubai** con il ruolo di "Investitore e Partner negli Investimenti immobiliari". Dettagli completi in [[Business Experience]].

Oggi è anche **coach professionista** e **content specialist/copywriter**, con un ruolo di comunicazione e marketing presso [[Coach Academy Cagliari]].

## Timeline — momenti chiave

| Periodo | Cosa succede |
|---|---|
| **18/06/1977** | Nasce a Cagliari |
| — | Diploma in ragioneria, poi laurea in Industrial Design allo IED di Roma (studi conclusi nel 2007) |
| **2007** | Subito dopo lo IED, esperienza formativa/lavorativa negli USA |
| **2007** | Fonda **ANTdesign**, studio multidisciplinare di design, grafica, comunicazione e fotografia — progetto MOD.U (termosifone alta gamma per ADHOC); pubblicazioni su *SALOON*, tra le 40 storie di successo IED, "Design Index" di *Design4* |
| **Dal 2014** | Passa alla libera professione, si concentra sulla fotografia di moda ed editoriale — fotografo ufficiale per Galleria Progetti alla prima fashion week sarda (EXTRO Discovery), collaborazioni con *Shopping Coach* |
...
## Letture — basi di conoscenza personale (nuovo, 2026-07-06)
Federico sta caricando testi/libri che considera basi della propria conoscenza, da integrare nel vault come capitale intellettuale — vedi `03 Risorse/Capitale Intellettuale/`, note con prefisso "Libro - ".
...
**Competenze che vuole acquisire**: public speaking ad alto livello, inglese business internazionale, intelligenza artificiale a livello d'élite.

**Evoluzione di ruolo desiderata**: da operativo a fondatore/guida strategica del gruppo, delega progressiva della gestione quotidiana, focus su relazioni/PR e macro-strategia — si descrive come "attaccante" (traccia la visione), non "portiere".
...
Schema completo e dettagli in [[Business Experience]] → "Gerarchia dei progetti".
...
| Strumento | Uso |
|---|---|
| Obsidian (questo vault) | Second brain: cattura, progetti, conoscenza |
| NotebookLM | Ricerca e scrittura assistita per contenuti (un notebook per cliente/progetto/persona) — processo: [[Processo - Ricerca con NotebookLM]] |
| Canva | Produzione grafica caroselli/social |
| WordPress (Elementor + Yoast) | Pubblicazione blog clienti |
| `D:\_CLAUDE` | Cartella locale di lavoro: file sorgente, script, export dei progetti |
| NotebookLM "FG Second Brain" | Notebook dedicato a questo vault, id `901fe146-3107-40e1-a829-f5341934c077` — 13 fonti, tutte confermate/verificate, citano esplicitamente Federico Gaudino |

## Obiettivi in corso
<!-- TODO: obiettivi professionali per il periodo in corso (es. 2026) -->
- [ ]

## Presenza online — punto di attenzione
Il sito storico federicogaudino.com è ancora il primo risultato quando qualcuno ti cerca online, ma comunica il vecchio posizionamento (fotografo/designer). Il nuovo sito ([[Federico Gaudino - Sito]]) non risulta ancora pubblicato.

**Social confermati (verificati direttamente, 2026-07-02):**
- **YouTube**: canale `@gaudino77` — bio conferma i 40 anni di attività immobiliare del padre e l'azienda di famiglia, con link a gaudinoinvestment.com (dominio confermato reale, oggi offline).
- **Instagram**: `@federicogaudino_art` — "Federico Gaudino Fotografia", 10,9K follower, bio fotografia/video/fine art, link a federicogaudino.com.
- **LinkedIn**: `it.linkedin.com/in/federico-gaudino-74374b26` — profilo pubblico confermato, posizione attuale "gaudino Investment", formazione IED, progetti collegati DEWINE, Sardinia Investment, Sardinia Location.
- **Pinterest**: profilo `federicogaudino` — Federico Gaudino Photography, coerente col dominio federicogaudino.com.
