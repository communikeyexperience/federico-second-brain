...
Federico propone di scegliere **5-6 beta tester** in totale, distribuiti su fasce di impegno economico crescente:
...
**Modello alternativo, non deciso**: invece di far scegliere/pagare lo strumento AI al cliente, Communikey potrebbe aprire e gestire direttamente gli account (es. Claude) e darli "in gestione" al cliente dietro una quota mensile fissa — Federico lo segnala esplicitamente come alternativa da valutare, non come decisione presa.
...
- **Fee Fascia 1 confermata**: **~500€** + costi esterni a carico del beta tester (conferma l'ipotesi già segnalata, non 500.000€).
- **Strumento AI, per ora**: **Claude / Claude Code** — non ancora deciso se il cliente lo gestisce da sé o se Communikey apre/gestisce gli account (vedi sotto, resta esplicitamente aperto).
- **Roster Fascia 0 (zero fee, sempre spese esterne a carico loro)**: **Sanja** (= Sanja Rakitnican, moglie di Federico, di [[Piano Marketing - Sany Nail & Beauty|Sany Nail & Beauty]] — collegamento chiarito solo ora) + **Daniela** (definita da Federico scherzosamente "futura moglie di Cristiano" — probabile persona vicina a Cristiano, non conferma letterale) + uno slot lasciato alla valutazione di Cristiano, ancora da nominare.
- **Roster Fascia 1 (~500€)**: **Matteo Gaudino**, **Riccardo Fagioli**, **Annalisa Pinna**, **Ninni** (Giovanni Spissu, [[Coach Academy Cagliari]]) + una persona indicata come **"Alessandro" poi corretta in "Gino"** (Federico si autocorregge in registrazione, non chiaro quale dei due) che offrirebbe **spazio di rappresentanza in cambio**, non una fee in denaro — accordo di scambio, non cash.
- **Fascia 2 (30%)**: rimandata di proposito — "valuteremo chi, ma prima dobbiamo fare questo test" (Fascia 0-1 prima).
- **Modello account AI gestiti da Communikey**: resta esplicitamente **da valutare**, non deciso — Federico stesso pone la domanda se sia "meglio evitare" o "una cosa che possiamo valutare, se non ci complica troppo la vita".

## Seguito 2026-07-22 (terzo giro) — chiusure e ricerca ToS
...
- **Slot Fascia 0 lasciato a Cristiano**: Federico menziona un frammento poco chiaro in registrazione ("sarebbe meglio farlo provare a [nome incomprensibile]") — da riascoltare/chiarire, non è stato possibile trascriverlo con sicurezza.
- **Conferma identità "Daniela"**: probabile persona vicina a Cristiano (battuta di Federico), cognome e ruolo esatto non confermati.
- **Modello di gestione account AI**: esplicitamente in valutazione, non deciso — vedi sopra.
- **Software oltre a Claude/Claude Code**: Cristiano parlava di "cloud e altri eventuali software necessari" — solo Claude confermato finora, il resto non specificato.
- **Numero totale beta tester**: il roster nominato finora (Fascia 0: 2-3 persone, Fascia 1: 5 persone) supera già la stima iniziale di "5-6 totali" — non necessariamente un problema, ma vale la pena notarlo prima di aggiungere altri nomi.
