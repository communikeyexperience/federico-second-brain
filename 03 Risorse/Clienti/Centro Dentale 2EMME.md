---
tipo: cliente
settore: "Odontoiatria / cure dentistiche"
referente: "Stefano Vacca (titolare)"
stato_relazione: attivo
tags: [2emme, odontoiatria, masullas]
---

# Centro Dentale 2EMME

## Chi è
Centro dentale a **Masullas** — cure dentistiche per pazienti. Collaborazione attiva da **oltre un anno** sullo sviluppo di asset di marketing e comunicazione.

## Referente
**Stefano Vacca** — titolare (cognome confermato 2026-07-03). Altro contatto chiave: **Clelia**, sua moglie e braccio destro/supervisor dei lavori (nome corretto 2026-07-03, in precedenza registrato erroneamente come "Clayda").

## Come è nata la collaborazione
Presentazione di **Cinzia**, collaboratrice che si occupa della parte commerciale/vendita — è stata retribuita per l'introduzione.
...
- Canva: file `DAGup1yOwtM` (copia `DAHNGh20Twc`), 3 famiglie di template — modelli di riferimento: Marzo_bis_01di02, Maggio2026
