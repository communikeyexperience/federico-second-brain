...
- [x] **Autore della Roadmap — risolto 2026-08-01**: confermato direttamente da Federico — l'ha scritta lui, fondamenta e analisi comprese, ispirandosi al metodo di [[Analisi - Company Brain di Giovanni Beggiato vs FG Second Brain|Giovanni Beggiato]] (non Simone Dongu, ipotesi scartata — vedi [[Persone]]). Spiega anche il claim RAG multi-tenant "già sviluppato": nel metodo di Beggiato il RAG/database vettoriale è la soglia consigliata solo oltre 20.000 note — questo vault ne ha 305, due ordini di grandezza sotto. La Roadmap sembra descrivere come "già fatto" un passo di scala futuro, non lo stato reale di oggi — coerente con un registro da investitori più che con una descrizione tecnica accurata. Resta da chiarire con Federico se è una scelta di framing deliberata (per una data room) o una sovrastima in buona fede.
