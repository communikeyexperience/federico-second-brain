...
Federico ha fornito i due asset di logo reali il 2026-08-04, durante la costruzione del primo documento brandizzato (il Protocollo di Delivery). **Sostituiscono il wordmark tipografico provvisorio** usato in [[SOP - Identità Visiva ZirkonIA]] fino a quel momento — vedi lì per come si sia arrivati a un primo tentativo "a orecchio", oggi superato da questi file reali.
...
| Ruolo | Hex | Fonte |
|---|---|---|
| Sfondo brand | `#050607` | fondo di entrambi i file |
| Gradiente icona — verde | `#3BC79B` | angolo superiore/sinistro dell'icona |
| Gradiente icona — blu | `#3B93BA` | angolo destro/inferiore dell'icona |
| "Zirkon" cromato — chiaro | `#F4F5F6` | punto luce del testo |
| "Zirkon" cromato — ombra | `#B2B4B9` | zona in ombra del testo |
| "IA" blu — chiaro | `#9CCAFC` | parte alta della lettera |
| "IA" blu — scuro | `#5B90D1` | parte bassa della lettera |

Valori completi e regole d'uso in [[SOP - Identità Visiva ZirkonIA]] (versione 2, aggiornata il 2026-08-04 su questi asset reali).
