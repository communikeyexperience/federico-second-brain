...
data: "2026-07-02"
tipo: strategia
tags: [framework, decision-making, soci, budget]
---
...
1. **Chi è il cliente/pubblico dell'obiettivo a lungo termine dichiarato** — non quello di oggi. Spesso è diverso da chi entrambe le proposte in discussione stanno cercando di raggiungere.
2. **Le due posizioni sono davvero alternative, o sono fasi collegabili della stessa mossa?** Cassa e autorevolezza, ad esempio, non sono in competizione se una finanzia esplicitamente l'altra invece di contenderle lo stesso budget.
3. **Ogni posizione ha un tetto esplicito?** Chi spinge per il rischio (cassa aggressiva, o investimento a perdita) deve avere un limite dichiarato e una metrica di stop — altrimenti lo stallo si risolve per stanchezza, non per merito.
